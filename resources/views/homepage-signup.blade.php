    ...
    <div class="container py-md-5">
        <div class="row align-items-center">
          <div class="col-lg-7 py-3 py-md-5">
            <h1 class="display-3">Sick of Tipping?</h1>
            <p class="lead text-muted">
                Let's fight back! Register here to help track establishiments <br>
                that abuse your good will with excessive tipping.
            </p>
          </div>
          <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
            <form action="/register" method="POST" id="registration-form">
              ...
              <div class="form-group">
                ...
                {{-- Need to add "_confirmation" for the confirm functionality to work --}}
